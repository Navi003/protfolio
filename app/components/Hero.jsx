  ...
  return (
    <div className="pb-6 sm:pb-6 md:pb-0 bg-base-medium">
      <div className="xl:w-[1200px] relative mx-auto md:grid-cols-2 md:grid">
        <div className="justify-center hidden w-full gap-3 mb-5 space-x-2 text-5xl font-bold uppercase md:absolute md:bottom-0 md:z-30 md:flex text-primary-60">
        ...
        <div className="px-4 mt-5 md:col-start-1 md:row-start-1 md:my-auto ">
          ...
          <div className="flex justify-center gap-3 space-x-6 md:block mt-7">
            <Button className="px-16 md:px-10 xl:">Hire Me</Button>
            <Button href="/projects" className="md:px-10 lg:px-16">
              Projects
            </Button>
          </div>
        </div>
